...
### Řízení
Hlavní řídicí jednotkou systému bude mikrořadič STM32WLE5JC LoRa-E5 mini, taktovaný na 2 MHz. Ten bude disponovat integrovaným LoRa modulem, komunikujícím přes LoRaWAN stack (12 dBm, SF9, BW 125 kHz, CR 4 / 5, Class A neboli RX1 + RX2 a délka příjmového okna automaticky podle driftu krystalu). Pro komunikaci bude použit LDO režim namísto efektivnějšího SMPS režimu. Tato volba sice zdvojnásobí spotřebu při komunikaci, ale ta bude stále zanedbatelná. LDO režim je navíc jednodušší. LoRa modul umožní na rozdíl od Wi-Fi komunikaci na velké vzdálenosti při nízké spotřebě energie. NB-IoT má taktéž vyšší spotřebu. U každého snáškového hnízda bude umístěn další mikrořadič STM32 NUCLEO-L031K6 (2 MHz). Ten má integrovaný programátor, který bude využit i pro hlavní řadič.
...
Při pohybu dvířek budou postupně spínány (debounce 50 ms), respektive rozpínány dva pákové koncové mikrospínače. Kontakt COM bude připojen k akumulátoru a kontakt NO spolu se silným 1 kΩ externím pulldown rezistorem k M. Koncové spínače představují jednoduché a energeticky nenáročné řešení určování krajních poloh.
...
V horní i dolní části hranolku budou ve svislé ose zapuštěny dva pákové koncové mikrospínače.
