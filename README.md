...
Data budou z kurníku odesílána ve třech a více bajtech. První bajt ponese 7 bitů pro napětí solárního panelu (rozsah 0–9 V, krok 70 mV) a 1 bit pro indikaci zapnutí/vypnutí kritického režimu. Druhý bajt bude obsahovat 6 bitů pro napětí akumulátoru (5,75–8 V, krok 35 mV) a 2 bity pro stav dvířek (otevřeno / zavřeno / porucha). Další bajty budou po čtyřech bitech alokovány pro počet vajec v jednotlivých snáškových hnízdech (0–10 vajec na hnízdo). Kurník bude data přenášet každou hodinu po kontrole stavu hnízd a dvakrát denně při změně stavu dvířek — v tom případě odešle pouze první dva bajty. Manuální ovládání využije jediný bajt: jeden bit pro vypnutí/zapnutí systému, druhý pro vypnutí/zapnutí kritického režimu (nízké napětí na akumulátoru) a dva bity pro ovládání dvířek (zavřít / otevřít / zablokovat / odblokovat).
