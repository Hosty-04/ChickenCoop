...
Další řídicí jednotky nebudou po většinu napájeny; potřebné informace si uloží do paměti EEPROM. Po připojení napájení se daný řadič přepne do režimu LP Run (MSI, 131 kHz) a ihned po vykonání úkonu se vrátí zpět do režimu Stop bez RTC. Řadiče budou postupně probouzeny a úkolovány pomocí sběrnice LPUART přes hlavní řadič, proto nepotřebují vlastní RTC hodiny. Napětí interního regulátoru bude možno kvůli nízké taktovací frekvenci trvale snížit na nižší hodnotu (Voltage Scale 2). Pro inicializaci mikrořadičů bude vyhrazen zanedbatelný čas 10 ms.
