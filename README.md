...
Data budou z kurníku odesílána pomocí 4 bajtů. První bajt bude obsahovat 1 bit pro indikaci zapnutí / vypnutí systému a 2 bity pro indikaci stavu dvířek (ON / OFF / zaseknuto). Zbytek bajtu a dvou dalších bude zaplněn 4 bitovými informacemi o vejcích v 5 snáškových hnízdech (0-10 vajec na hnízdo). Poslední bajt bude obsahovat informace o napětí solárního panelu (0 - 6 V, krok 0,4 V) a akumulátoru (5,4 - 6 V, krok 50 mV). Manuální ovládání bude využívat pouze 1 bajtu, jeden bit bude využit pro vypnutí / zapnutí systému a další bit pro ovládání dvířek (ON / OFF).
